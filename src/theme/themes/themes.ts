...
export default [
  {
    ...
    "config": {
      "themeColors": {
        "c-primary": "rgb(17, 24, 39)",
        "c-primary-dark-100": "rgb(15,22,35)",
        "c-primary-dark-100-alpha-100": "rgba(15, 22, 35, 0.90)",
        "c-primary-alpha-100": "rgba(17, 24, 39, 0.90)",
        "c-primary-dark-100-alpha-200": "rgba(15, 22, 35, 0.80)",
        "c-primary-alpha-200": "rgba(17, 24, 39, 0.80)",
        "c-primary-dark-100-alpha-300": "rgba(15, 22, 35, 0.70)",
        "c-primary-alpha-300": "rgba(17, 24, 39, 0.70)",
        "c-primary-dark-100-alpha-400": "rgba(15, 22, 35, 0.60)",
        "c-primary-alpha-400": "rgba(17, 24, 39, 0.60)",
        "c-primary-dark-100-alpha-500": "rgba(15, 22, 35, 0.50)",
        "c-primary-alpha-500": "rgba(17, 24, 39, 0.50)",
        "c-primary-dark-100-alpha-600": "rgba(15, 22, 35, 0.40)",
        "c-primary-alpha-600": "rgba(17, 24, 39, 0.40)",
        "c-primary-dark-100-alpha-700": "rgba(15, 22, 35, 0.30)",
        "c-primary-alpha-700": "rgba(17, 24, 39, 0.30)",
        "c-primary-dark-100-alpha-800": "rgba(15, 22, 35, 0.20)",
        "c-primary-alpha-800": "rgba(17, 24, 39, 0.20)",
        "c-primary-dark-100-alpha-900": "rgba(15, 22, 35, 0.10)",
        "c-primary-alpha-900": "rgba(17, 24, 39, 0.10)",
        "c-primary-dark-200": "rgb(14,20,32)",
        "c-primary-dark-200-alpha-100": "rgba(14, 20, 32, 0.90)",
        "c-primary-dark-200-alpha-200": "rgba(14, 20, 32, 0.80)",
        "c-primary-dark-200-alpha-300": "rgba(14, 20, 32, 0.70)",
        "c-primary-dark-200-alpha-400": "rgba(14, 20, 32, 0.60)",
        "c-primary-dark-200-alpha-500": "rgba(14, 20, 32, 0.50)",
        "c-primary-dark-200-alpha-600": "rgba(14, 20, 32, 0.40)",
        "c-primary-dark-200-alpha-700": "rgba(14, 20, 32, 0.30)",
        "c-primary-dark-200-alpha-800": "rgba(14, 20, 32, 0.20)",
        "c-primary-dark-200-alpha-900": "rgba(14, 20, 32, 0.10)",
        "c-primary-dark-300": "rgb(13,18,29)",
        "c-primary-dark-300-alpha-100": "rgba(13, 18, 29, 0.90)",
        "c-primary-dark-300-alpha-200": "rgba(13, 18, 29, 0.80)",
        "c-primary-dark-300-alpha-300": "rgba(13, 18, 29, 0.70)",
        "c-primary-dark-300-alpha-400": "rgba(13, 18, 29, 0.60)",
        "c-primary-dark-300-alpha-500": "rgba(13, 18, 29, 0.50)",
        "c-primary-dark-300-alpha-600": "rgba(13, 18, 29, 0.40)",
        "c-primary-dark-300-alpha-700": "rgba(13, 18, 29, 0.30)",
        "c-primary-dark-300-alpha-800": "rgba(13, 18, 29, 0.20)",
        "c-primary-dark-300-alpha-900": "rgba(13, 18, 29, 0.10)",
        "c-primary-dark-400": "rgb(12,16,26)",
        "c-primary-dark-400-alpha-100": "rgba(12, 16, 26, 0.90)",
        "c-primary-dark-400-alpha-200": "rgba(12, 16, 26, 0.80)",
        "c-primary-dark-400-alpha-300": "rgba(12, 16, 26, 0.70)",
        "c-primary-dark-400-alpha-400": "rgba(12, 16, 26, 0.60)",
        "c-primary-dark-400-alpha-500": "rgba(12, 16, 26, 0.50)",
        "c-primary-dark-400-alpha-600": "rgba(12, 16, 26, 0.40)",
        "c-primary-dark-400-alpha-700": "rgba(12, 16, 26, 0.30)",
        "c-primary-dark-400-alpha-800": "rgba(12, 16, 26, 0.20)",
        "c-primary-dark-400-alpha-900": "rgba(12, 16, 26, 0.10)",
        "c-primary-dark-500": "rgb(11,14,23)",
        "c-primary-dark-500-alpha-100": "rgba(11, 14, 23, 0.90)",
        "c-primary-dark-500-alpha-200": "rgba(11, 14, 23, 0.80)",
        "c-primary-dark-500-alpha-300": "rgba(11, 14, 23, 0.70)",
        "c-primary-dark-500-alpha-400": "rgba(11, 14, 23, 0.60)",
        "c-primary-dark-500-alpha-500": "rgba(11, 14, 23, 0.50)",
        "c-primary-dark-500-alpha-600": "rgba(11, 14, 23, 0.40)",
        "c-primary-dark-500-alpha-700": "rgba(11, 14, 23, 0.30)",
        "c-primary-dark-500-alpha-800": "rgba(11, 14, 23, 0.20)",
        "c-primary-dark-500-alpha-900": "rgba(11, 14, 23, 0.10)",
        "c-primary-dark-600": "rgb(10,13,21)",
        "c-primary-dark-600-alpha-100": "rgba(10, 13, 21, 0.90)",
        "c-primary-dark-600-alpha-200": "rgba(10, 13, 21, 0.80)",
        "c-primary-dark-600-alpha-300": "rgba(10, 13, 21, 0.70)",
        "c-primary-dark-600-alpha-400": "rgba(10, 13, 21, 0.60)",
        "c-primary-dark-600-alpha-500": "rgba(10, 13, 21, 0.50)",
        "c-primary-dark-600-alpha-600": "rgba(10, 13, 21, 0.40)",
        "c-primary-dark-600-alpha-700": "rgba(10, 13, 21, 0.30)",
        "c-primary-dark-600-alpha-800": "rgba(10, 13, 21, 0.20)",
        "c-primary-dark-600-alpha-900": "rgba(10, 13, 21, 0.10)",
        "c-primary-dark-700": "rgb(9,12,19)",
        "c-primary-dark-700-alpha-100": "rgba(9, 12, 19, 0.90)",
        "c-primary-dark-700-alpha-200": "rgba(9, 12, 19, 0.80)",
        "c-primary-dark-700-alpha-300": "rgba(9, 12, 19, 0.70)",
        "c-primary-dark-700-alpha-400": "rgba(9, 12, 19, 0.60)",
        "c-primary-dark-700-alpha-500": "rgba(9, 12, 19, 0.50)",
        "c-primary-dark-700-alpha-600": "rgba(9, 12, 19, 0.40)",
        "c-primary-dark-700-alpha-700": "rgba(9, 12, 19, 0.30)",
        "c-primary-dark-700-alpha-800": "rgba(9, 12, 19, 0.20)",
        "c-primary-dark-700-alpha-900": "rgba(9, 12, 19, 0.10)",
        "c-primary-dark-800": "rgb(8,11,17)",
        "c-primary-dark-800-alpha-100": "rgba(8, 11, 17, 0.90)",
        "c-primary-dark-800-alpha-200": "rgba(8, 11, 17, 0.80)",
        "c-primary-dark-800-alpha-300": "rgba(8, 11, 17, 0.70)",
        "c-primary-dark-800-alpha-400": "rgba(8, 11, 17, 0.60)",
        "c-primary-dark-800-alpha-500": "rgba(8, 11, 17, 0.50)",
        "c-primary-dark-800-alpha-600": "rgba(8, 11, 17, 0.40)",
        "c-primary-dark-800-alpha-700": "rgba(8, 11, 17, 0.30)",
        "c-primary-dark-800-alpha-800": "rgba(8, 11, 17, 0.20)",
        "c-primary-dark-800-alpha-900": "rgba(8, 11, 17, 0.10)",
        "c-primary-dark-900": "rgb(7,10,15)",
        "c-primary-dark-900-alpha-100": "rgba(7, 10, 15, 0.90)",
        "c-primary-dark-900-alpha-200": "rgba(7, 10, 15, 0.80)",
        "c-primary-dark-900-alpha-300": "rgba(7, 10, 15, 0.70)",
        "c-primary-dark-900-alpha-400": "rgba(7, 10, 15, 0.60)",
        "c-primary-dark-900-alpha-500": "rgba(7, 10, 15, 0.50)",
        "c-primary-dark-900-alpha-600": "rgba(7, 10, 15, 0.40)",
        "c-primary-dark-900-alpha-700": "rgba(7, 10, 15, 0.30)",
        "c-primary-dark-900-alpha-800": "rgba(7, 10, 15, 0.20)",
        "c-primary-dark-900-alpha-900": "rgba(7, 10, 15, 0.10)",
        "c-primary-dark-1000": "rgb(6,9,14)",
        "c-primary-dark-1000-alpha-100": "rgba(6, 9, 14, 0.90)",
        "c-primary-dark-1000-alpha-200": "rgba(6, 9, 14, 0.80)",
        "c-primary-dark-1000-alpha-300": "rgba(6, 9, 14, 0.70)",
        "c-primary-dark-1000-alpha-400": "rgba(6, 9, 14, 0.60)",
        "c-primary-dark-1000-alpha-500": "rgba(6, 9, 14, 0.50)",
        "c-primary-dark-1000-alpha-600": "rgba(6, 9, 14, 0.40)",
        "c-primary-dark-1000-alpha-700": "rgba(6, 9, 14, 0.30)",
        "c-primary-dark-1000-alpha-800": "rgba(6, 9, 14, 0.20)",
        "c-primary-dark-1000-alpha-900": "rgba(6, 9, 14, 0.10)",
        "c-primary-light-100": "rgb(65,70,82)",
        "c-primary-light-100-alpha-100": "rgba(65, 70, 82, 0.90)",
        "c-primary-light-100-alpha-200": "rgba(65, 70, 82, 0.80)",
        "c-primary-light-100-alpha-300": "rgba(65, 70, 82, 0.70)",
        "c-primary-light-100-alpha-400": "rgba(65, 70, 82, 0.60)",
        "c-primary-light-100-alpha-500": "rgba(65, 70, 82, 0.50)",
        "c-primary-light-100-alpha-600": "rgba(65, 70, 82, 0.40)",
        "c-primary-light-100-alpha-700": "rgba(65, 70, 82, 0.30)",
        "c-primary-light-100-alpha-800": "rgba(65, 70, 82, 0.20)",
        "c-primary-light-100-alpha-900": "rgba(65, 70, 82, 0.10)",
        "c-primary-light-200": "rgb(103,107,117)",
        "c-primary-light-200-alpha-100": "rgba(103, 107, 117, 0.90)",
        "c-primary-light-200-alpha-200": "rgba(103, 107, 117, 0.80)",
        "c-primary-light-200-alpha-300": "rgba(103, 107, 117, 0.70)",
        "c-primary-light-200-alpha-400": "rgba(103, 107, 117, 0.60)",
        "c-primary-light-200-alpha-500": "rgba(103, 107, 117, 0.50)",
        "c-primary-light-200-alpha-600": "rgba(103, 107, 117, 0.40)",
        "c-primary-light-200-alpha-700": "rgba(103, 107, 117, 0.30)",
        "c-primary-light-200-alpha-800": "rgba(103, 107, 117, 0.20)",
        "c-primary-light-200-alpha-900": "rgba(103, 107, 117, 0.10)",
        "c-primary-light-300": "rgb(133,137,145)",
        "c-primary-light-300-alpha-100": "rgba(133, 137, 145, 0.90)",
        "c-primary-light-300-alpha-200": "rgba(133, 137, 145, 0.80)",
        "c-primary-light-300-alpha-300": "rgba(133, 137, 145, 0.70)",
        "c-primary-light-300-alpha-400": "rgba(133, 137, 145, 0.60)",
        "c-primary-light-300-alpha-500": "rgba(133, 137, 145, 0.50)",
        "c-primary-light-300-alpha-600": "rgba(133, 137, 145, 0.40)",
        "c-primary-light-300-alpha-700": "rgba(133, 137, 145, 0.30)",
        "c-primary-light-300-alpha-800": "rgba(133, 137, 145, 0.20)",
        "c-primary-light-300-alpha-900": "rgba(133, 137, 145, 0.10)",
        "c-primary-light-400": "rgb(157,161,167)",
        "c-primary-light-400-alpha-100": "rgba(157, 161, 167, 0.90)",
        "c-primary-light-400-alpha-200": "rgba(157, 161, 167, 0.80)",
        "c-primary-light-400-alpha-300": "rgba(157, 161, 167, 0.70)",
        "c-primary-light-400-alpha-400": "rgba(157, 161, 167, 0.60)",
        "c-primary-light-400-alpha-500": "rgba(157, 161, 167, 0.50)",
        "c-primary-light-400-alpha-600": "rgba(157, 161, 167, 0.40)",
        "c-primary-light-400-alpha-700": "rgba(157, 161, 167, 0.30)",
        "c-primary-light-400-alpha-800": "rgba(157, 161, 167, 0.20)",
        "c-primary-light-400-alpha-900": "rgba(157, 161, 167, 0.10)",
        "c-primary-light-500": "rgb(177,180,185)",
        "c-primary-light-500-alpha-100": "rgba(177, 180, 185, 0.90)",
        "c-primary-light-500-alpha-200": "rgba(177, 180, 185, 0.80)",
        "c-primary-light-500-alpha-300": "rgba(177, 180, 185, 0.70)",
        "c-primary-light-500-alpha-400": "rgba(177, 180, 185, 0.60)",
        "c-primary-light-500-alpha-500": "rgba(177, 180, 185, 0.50)",
        "c-primary-light-500-alpha-600": "rgba(177, 180, 185, 0.40)",
        "c-primary-light-500-alpha-700": "rgba(177, 180, 185, 0.30)",
        "c-primary-light-500-alpha-800": "rgba(177, 180, 185, 0.20)",
        "c-primary-light-500-alpha-900": "rgba(177, 180, 185, 0.10)",
        "c-primary-light-600": "rgb(193,195,199)",
        "c-primary-light-600-alpha-100": "rgba(193, 195, 199, 0.90)",
        "c-primary-light-600-alpha-200": "rgba(193, 195, 199, 0.80)",
        "c-primary-light-600-alpha-300": "rgba(193, 195, 199, 0.70)",
        "c-primary-light-600-alpha-400": "rgba(193, 195, 199, 0.60)",
        "c-primary-light-600-alpha-500": "rgba(193, 195, 199, 0.50)",
        "c-primary-light-600-alpha-600": "rgba(193, 195, 199, 0.40)",
        "c-primary-light-600-alpha-700": "rgba(193, 195, 199, 0.30)",
        "c-primary-light-600-alpha-800": "rgba(193, 195, 199, 0.20)",
        "c-primary-light-600-alpha-900": "rgba(193, 195, 199, 0.10)",
        "c-primary-light-700": "rgb(205,207,210)",
        "c-primary-light-700-alpha-100": "rgba(205, 207, 210, 0.90)",
        "c-primary-light-700-alpha-200": "rgba(205, 207, 210, 0.80)",
        "c-primary-light-700-alpha-300": "rgba(205, 207, 210, 0.70)",
        "c-primary-light-700-alpha-400": "rgba(205, 207, 210, 0.60)",
        "c-primary-light-700-alpha-500": "rgba(205, 207, 210, 0.50)",
        "c-primary-light-700-alpha-600": "rgba(205, 207, 210, 0.40)",
        "c-primary-light-700-alpha-700": "rgba(205, 207, 210, 0.30)",
        "c-primary-light-700-alpha-800": "rgba(205, 207, 210, 0.20)",
        "c-primary-light-700-alpha-900": "rgba(205, 207, 210, 0.10)",
        "c-primary-light-800": "rgb(215,217,219)",
        "c-primary-light-800-alpha-100": "rgba(215, 217, 219, 0.90)",
        "c-primary-light-800-alpha-200": "rgba(215, 217, 219, 0.80)",
        "c-primary-light-800-alpha-300": "rgba(215, 217, 219, 0.70)",
        "c-primary-light-800-alpha-400": "rgba(215, 217, 219, 0.60)",
        "c-primary-light-800-alpha-500": "rgba(215, 217, 219, 0.50)",
        "c-primary-light-800-alpha-600": "rgba(215, 217, 219, 0.40)",
        "c-primary-light-800-alpha-700": "rgba(215, 217, 219, 0.30)",
        "c-primary-light-800-alpha-800": "rgba(215, 217, 219, 0.20)",
        "c-primary-light-800-alpha-900": "rgba(215, 217, 219, 0.10)",
        "c-primary-light-900": "rgb(223,225,226)",
        "c-primary-light-900-alpha-100": "rgba(223, 225, 226, 0.90)",
        "c-primary-light-900-alpha-200": "rgba(223, 225, 226, 0.80)",
        "c-primary-light-900-alpha-300": "rgba(223, 225, 226, 0.70)",
        "c-primary-light-900-alpha-400": "rgba(223, 225, 226, 0.60)",
        "c-primary-light-900-alpha-500": "rgba(223, 225, 226, 0.50)",
        "c-primary-light-900-alpha-600": "rgba(223, 225, 226, 0.40)",
        "c-primary-light-900-alpha-700": "rgba(223, 225, 226, 0.30)",
        "c-primary-light-900-alpha-800": "rgba(223, 225, 226, 0.20)",
        "c-primary-light-900-alpha-900": "rgba(223, 225, 226, 0.10)",
